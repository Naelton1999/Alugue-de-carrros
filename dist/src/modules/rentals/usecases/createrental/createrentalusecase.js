...
var Createrentalusecase = /** @class */ (function () {
    function Createrentalusecase(rentalsrepository, dateprovider, carrepository) {
    ...
    Createrentalusecase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var minimunhour, carUnavailable, rentalopentTouser, datenow, compare, rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        rental = _b.sent();
                        return [4 /*yield*/, this.carrepository.updateAvailable(car_id, false)];
                    case 4:
                        _b.sent();
    ...
    Createrentalusecase = __decorate([
        ...
        __param(2, (0, tsyringe_1.inject)("Carrepository")),
