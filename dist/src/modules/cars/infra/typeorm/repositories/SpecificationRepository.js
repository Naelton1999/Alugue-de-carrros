...
var Especification_1 = require("../entities/Especification");
var SpecificationRepository = /** @class */ (function () {
    function SpecificationRepository() {
        this.repository = (0, typeorm_1.getRepository)(Especification_1.Especification);
    }
    SpecificationRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        specificationRepository = this.repository.create({
                            description: description,
                            name: name,
                        });
                        return [4 /*yield*/, this.repository.save(specificationRepository)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, specificationRepository];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        specificationRepository = _a.sent();
                        return [2 /*return*/, specificationRepository];
                }
            });
        });
