...
var Createcarusecase = /** @class */ (function () {
    function Createcarusecase(carrepository) {
    ...
    Createcarusecase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var caralreadyexist, car;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.carrepository.findByLicensePlate(license_plate)];
                    case 1:
                        caralreadyexist = _b.sent();
                        if (caralreadyexist) {
                            throw new Apperror_1.Apperror("car already exist");
                        }
                        ;
                        return [4 /*yield*/, this.carrepository.create({
                                name: name,
