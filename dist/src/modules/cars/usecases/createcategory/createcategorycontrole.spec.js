...
describe("create category controller", function () {
    ...
    it("should be able to create a new category", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, reflesh_token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    reflesh_token = responseToken.body.reflesh_token;
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/categories")
                            .send({
                            name: "Category supertest",
                            description: "Category supertest"
                        }).set({ Authorization: "Bearer ".concat(reflesh_token) })];
                case 2:
                    response = _a.sent();
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post("/categories").send({
                            ...
                            .set({
                            Authorization: "Bearer ".concat(reflesh_token)
                        })];
                case 2:
                    response = _a.sent();
