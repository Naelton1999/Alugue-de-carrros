...
describe('Autenticate user', function () {
    ...
    it("should not be able to authenticate an noexistent user", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(authenticateuserusecase.execute({
                        email: "false@email.com",
                        password: "1234"
                    })).rejects.toEqual(new Apperror_1.Apperror("email ou senha incorreto"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("should not be able to authenticate with incorret password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
