...
var UsersRepository = /** @class */ (function () {
    function UsersRepository() {
        this.repository = (0, typeorm_1.getRepository)(users_1.User);
    }
    UsersRepository.prototype.create = function (_a) {
        var name = _a.name, password = _a.password, email = _a.email, driver_license = _a.driver_license, avatar = _a.avatar, id = _a.id;
